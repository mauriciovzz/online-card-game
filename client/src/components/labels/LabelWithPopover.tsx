...
export const LabelWithPopover = ({ text, description, data, error }: Props) => {
      ...
      <Group gap={3}>
        ...
        >
          ...
          <Popover.Dropdown p="sm">
            <Stack gap="sm" w={340} style={{ userSelect: "none" }}>
              {description && (
                <>
                  <Stack gap={0}>
                    <Text fw={700}>{t(description.title)}</Text>
              ...
              {data.map(({ key, name, description, icon: Icon }) => (
